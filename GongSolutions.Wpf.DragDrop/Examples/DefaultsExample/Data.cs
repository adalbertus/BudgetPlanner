...
namespace DefaultsExample
{
    ...
    class Data : IDropTarget
    {
        public Data()
        {
            Collection1 = new ObservableCollection<ItemDto>();
            Collection2 = new ObservableCollection<ItemDto>();

            for (int n = 0; n < 100; ++n)
            {
                Collection1.Add(new ItemDto { Name = "Item " + n });
            }
        ...
        public ObservableCollection<ItemDto> Collection1 { get; private set; }
        public ObservableCollection<ItemDto> Collection2 { get; private set; }
